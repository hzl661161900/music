...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    private void initPreferences() {
        ...
        notifyOpenNetworks.setChecked(Global.getInt(getContentResolver(),
                Global.WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON, 0) == 1);
        ...
        if (sleepPolicyPref != null) {
            ...
            int value = Global.getInt(getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_SLEEP_POLICY.equals(key)) {
            try {
                ...
                Global.putInt(getContentResolver(), Global.WIFI_SLEEP_POLICY,
